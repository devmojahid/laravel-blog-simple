										...
										<div class="widget tab_widgets mb30">
											<div class="single_post widgets_small">
												<div class="post_img">
													<div class="img_wrap">
														<a href="#">
															<img src="{{asset('frontend')}}/assets/img/header/widget/tab1.jpg" alt="">
														</a>
													</div>
												</div>
											...
											<div class="single_post widgets_small">
												<div class="post_img">
													<div class="img_wrap">
														<a href="#">
															<img src="{{asset('frontend')}}/assets/img/header/widget/tab2.jpg" alt="">
														</a>
													</div>
												</div>
												<div class="single_post_text">
											...
											<div class="single_post widgets_small">
												<div class="post_img">
													<div class="img_wrap">
														<a href="#">
															<img src="{{asset('frontend')}}/assets/img/header/widget/tab3.jpg" alt="">
														</a>
													</div>
												</div>
												<div class="single_post_text">
											...
											<div class="single_post widgets_small">
												<div class="post_img">
													<div class="img_wrap">
														<a href="#">
															<img src="{{asset('frontend')}}/assets/img/header/widget/tab4.jpg" alt="">
														</a>
													</div>
												</div>
												<div class="single_post_text">
											...
											<div class="single_post widgets_small ldnane">
												<div class="post_img">
													<div class="img_wrap">
														<a href="#">
															<img src="{{asset('frontend')}}/assets/img/header/widget/tab5.jpg" alt="">
														</a>
													</div>
												</div>
												<div class="single_post_text">
