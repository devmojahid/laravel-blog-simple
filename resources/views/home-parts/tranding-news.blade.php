			...
			<div class="col-lg-6 col-lg-8">
				...
				<div class="carousel_post2_type3 nav_style1 owl-carousel">
					...
					<div class="single_post post_type3">
						<div class="post_img">
							<div class="img_wrap">
								<img src="{{asset('frontend')}}/assets/img/trending/trendbig1.jpg" alt="">
					...
					<div class="single_post post_type3">
						<div class="post_img">
							<div class="img_wrap">
								<img src="{{asset('frontend')}}/assets/img/trending/trendbig2.jpg" alt="">
							</div>
						</div>
						<div class="single_post_text">
							<div class="meta3">	<a href="#">TECHNOLOGY</a>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{asset('frontend')}}/assets/img/trending/transm4.jpg" alt="">
								</div>	<span class="tranding">
									<i class="fas fa-bolt"></i>
								</span>
							</div>
						...
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{asset('frontend')}}/assets/img/trending/transm5.jpg" alt="">
								</div>	<span class="tranding">
									<i class="fas fa-bolt"></i>
								</span>
							</div>
						...
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{asset('frontend')}}/assets/img/trending/transm6.jpg" alt="">
								</div>	<span class="tranding">
									<i class="fas fa-bolt"></i>
								</span>
							</div>
					...
					<div class="col-lg-6">
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{asset('frontend')}}/assets/img/trending/transm1.jpg" alt="">
								</div>	<span class="tranding">
									<i class="fas fa-bolt"></i>
								</span>
							</div>
						...
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{asset('frontend')}}/assets/img/trending/transm2.jpg" alt="">
								</div>	<span class="tranding">
									<i class="fas fa-bolt"></i>
								</span>
							</div>
