					...
					<div class="post_type2_carousel owl-carousel nav_style1">
						...
						<div class="single_post2_carousel">
							<div class="single_post widgets_small type8">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/most_view/mostsm1.jpg" alt="">
							...
							<div class="single_post widgets_small type8">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/most_view/mostsm2.jpg" alt="">
									</div>
								</div>
								<div class="single_post_text">
									<div class="meta2">	<a href="#">TECHNOLOGY</a>
							...
							<div class="single_post widgets_small type8">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/most_view/mostsm3.jpg" alt="">
									</div>	<span class="tranding">
										<i class="fas fa-bolt"></i>
									</span>
								</div>
							...
							<div class="single_post widgets_small type8">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/most_view/mostsm4.jpg" alt="">
									</div>	<span class="tranding">
										<i class="fas fa-bolt"></i>
									</span>
								</div>
							...
							<div class="single_post widgets_small type8">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/most_view/mostsm5.jpg" alt="">
									</div>
								</div>
								<div class="single_post_text">
									<div class="meta2">	<a href="#">TECHNOLOGY</a>
							...
							<div class="single_post widgets_small type8 ldnane">
								<div class="post_img">
									<div class="img_wrap">
										<img src="{{asset('frontend')}}/assets/img/blog/blog_small3.jpg" alt="">
									</div>
								</div>
								<div class="single_post_text">
									<div class="meta2">	<a href="#">TECHNOLOGY</a>
